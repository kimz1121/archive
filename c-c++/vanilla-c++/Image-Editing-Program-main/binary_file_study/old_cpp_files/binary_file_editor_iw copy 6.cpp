...
class bmp_editor
{
	...
	void read_header_bmp()
	{
		...
		struct file_header* temp_f_header_struct = NULL;
		struct info_header* temp_I_header_struct = NULL;

		temp_f_header_struct = &bitmap_FILE_HEADER;
		temp_I_header_struct = &bitmap_INFO_HEADER;
		...
		cout<<(uint32_t*)&bitmap_FILE_HEADER<<endl;
		cout<<(uint32_t*)&(bitmap_FILE_HEADER.bfType)<<endl;
		cout<<(uint32_t*)&(bitmap_FILE_HEADER.bfSize)<<endl;
		cout<<(uint32_t*)&(bitmap_FILE_HEADER.bfReserved1)<<endl;
