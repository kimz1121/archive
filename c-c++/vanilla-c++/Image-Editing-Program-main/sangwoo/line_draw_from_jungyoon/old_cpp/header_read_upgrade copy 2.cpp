...
class bmp_editor
{
    ...
    bmp_editor(const char *f_in_name)
    {
        ...
        cout<<"에디터 에러 의심 2"<<endl;

        f_in_image.read(rare_buff, size_of_file);

        cout<<"에디터 에러 의심 3"<<endl;
        ...
        cout<<"에디터 에러 의심 6"<<endl;


        read_data_bmp();    //데이터 읽어오기


        cout<<"에디터 에러 의심 7"<<endl;
