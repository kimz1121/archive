...
class bmp_editor
{
	...
	void test_draw_1()
	{
		...
		(*layer_arr[1]).store(edit_refined_data_buff, bitmap_INFO_HEADER.biWidth, bitmap_INFO_HEADER.biHeight);
		(*layer_arr[0]).store(edit_refined_data_buff, bitmap_INFO_HEADER.biWidth, bitmap_INFO_HEADER.biHeight); 
	}
