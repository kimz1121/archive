...
int main()
{
	...
	layer_1.clear();
	layer_1.area(0, 0, 19, 19);// 영역선택 전체
	
	layer_1.pixel(10, 10, 1, 0xff, 0xff, 0);
	layer_1.pixel(10, 11, 1, 0xff, 0xff, 0);
	layer_1.pixel(11, 10, 1, 0xff, 0xff, 0);
	layer_1.pixel(11, 11, 1, 0xff, 0xff, 0);
