/*
 * robot_arm_control_6.cpp
 *
 * Created: 2020-02-22 오후 3:46:29
 * Author : kimzt
 */ 
...
//<끝>==========================================
//<시작>========================================
int object_binary_making(char object_pin, char binary_char)
{
	char result_binary = 0;
	char not_binary = ~object_pin;
	result_binary |= (object_pin & binary_char);
	result_binary &= (not_binary | binary_char);
	//printf("%d\n", result_binary);
	return result_binary;
}
//<끝>==========================================
/*
int binary_fit_modifing(int object_pin, int binary_char, int object_bin_length, int signal_binary_length)
{
...
//<끝>==========================================
//<시작>========================================
void port_output_assistant(char port_name, char object_pin, char binary_char = 0b00000000)
{
	switch(port_name)
	{
		case 'a':
		case 'A':
		PORTA = object_binary_making(object_pin, binary_char);
		break;
		case 'b':
		case 'B':
		PORTB = object_binary_making(object_pin, binary_char);
		break;
		case 'c':
		case 'C':
		PORTC = object_binary_making(object_pin, binary_char);
		break;
		case 'd':
		case 'D':
		PORTD = object_binary_making(object_pin, binary_char);
		break;
		case 'e':
		case 'E':
		PORTE = object_binary_making(object_pin, binary_char);
		break;
		case 'f':
		case 'F':
		PORTF = object_binary_making(object_pin, binary_char);
		break;
	}
	//printf("%c : %d\n", port_name, object_binary_making(object_pin, binary_char));
}
//<끝>==========================================
...
//<시작>========================================
/*현재 사용안함.
int direction_value_clac_arg_3(long begin_point, long last_point, char driving_mode)
{
...
//<끝>==========================================
//<시작>========================================
void step_motor_driving_open_loop(char motor_port, char motor_pin, char* direction_value)
{
...
int main(void)
{
	...
	robot_arm_1.m1_stepper.presison = 1;
	robot_arm_1.m1_stepper.proper_direction = 1;
	
	robot_arm_1.m1_stepper.motor_port = 'b';
	robot_arm_1.m1_stepper.motor_pin = 0b00111111;
	...
	robot_arm_1.m3_stepper.presison = 1;
	robot_arm_1.m3_stepper.proper_direction = 1;
	
	robot_arm_1.m3_stepper.motor_port = 'b';
	robot_arm_1.m3_stepper.motor_pin = 0b00111111;
	...
	robot_arm_1.m4_stepper.presison = 1;
	robot_arm_1.m4_stepper.proper_direction = 1;
	
	robot_arm_1.m4_stepper.motor_port = 'b';
	robot_arm_1.m4_stepper.motor_pin = 0b00111111;
	...
	robot_arm_1.m5_servo_gripper.presison = 1;
	robot_arm_1.m5_servo_gripper.proper_direction = 1;
	
	robot_arm_1.m5_servo_gripper.motor_port = 'b';
	robot_arm_1.m5_servo_gripper.motor_pin = 0b00111111;
	...
	//current_position_caliberation(&robot_arm_1.m2_bldc);//용도가 무엇? = 모터캘리브 레이션 하위 호환.
