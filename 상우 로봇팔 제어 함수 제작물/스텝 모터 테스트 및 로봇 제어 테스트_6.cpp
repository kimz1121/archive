...
void whole_driving()
{
   while(rectangular_coordinate_macroscopic_compliment_checking(&robot_arm_1, &func_gripper) == 'n')
   {
      ...
      rectangular_coordinate_microscopic_compliment_checking(&robot_arm_1, &func_gripper);
...
int main(void)
{
   ...
   robot_arm_1.m2_stepper.step_per_revolution_presison = 64575;//1435*3*3*5
   ...
   */
   ...
   combine_ordering(&robot_arm_1, &func_gripper, 30, 0, 30, 0, 255, 1000);
