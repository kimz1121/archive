...
Servo L_F_prop;
//Servo L_B_prop;  //not used for one axis test
Servo R_F_prop;
//Servo R_B_prop;  //not used for one axis test
...
float roll_desired_angle = 0;     //This is the angle in which we whant the
 ...
 //Only ROLL is used for this one axis test
//////////////////////////////PID FOR PITCH//////////////////////////
...
pwm_L_F  = input_THROTTLE + roll_PID; //- pitch_PID;   //not used in this one axis example
...
//  {
  ...
  //L_B_prop.writeMicroseconds(pwm_L_B); //not used in the one axis example
  R_F_prop.writeMicroseconds(pwm_R_F); 
  //R_B_prop.writeMicroseconds(pwm_R_B); //not used in the one axis example
 // }
 /*
  if(!mot_activated)
  {
